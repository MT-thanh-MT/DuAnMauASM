...
public class QLNVLanguage {
    ...
    public QLNVLanguage(JButton btnQLNVSua, JButton btnQLNVThem, JButton btnQLNVXoa, JButton btnQLNVMoi, JLabel lblQLNVHoTen, JLabel lblQLNVMaNV, JLabel lblQLNVMatKhau, JLabel lblQLNVMatKhau2, JLabel lblQLNVSDT, JLabel lblQLNhanVienTitle, JRadioButton rdoQLNVNhanVien, JRadioButton rdoQLNVTruongPhong, JTable tblQLNV, JPanel pnlVaiTro) {
    ...
    public void changeLanguage(int choice) {
        switch (choice) {
            case 0:
                ...
                this.lblQLNVSDT.setText("Số điện thoại");
                ...
                this.tblQLNV.getColumnModel().getColumn(4).setHeaderValue("SỐ ĐIỆN THOẠI");
            ...
            case 1:
                ...
                this.lblQLNVSDT.setText("Phone number");
                ...
                this.tblQLNV.getColumnModel().getColumn(4).setHeaderValue("Phone number");
                this.tblQLNV.getTableHeader().repaint();
                pnlVaiTro.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1),
