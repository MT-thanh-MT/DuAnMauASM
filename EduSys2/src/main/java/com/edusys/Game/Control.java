...
public class Control {
    ...
    private FrogGame f;
    JLabel btnF = new JLabel(new javax.swing.ImageIcon(getClass().getResource("/com/edusys/icons/Bird.png")));
    private Timer timer;
    ...
    public void showMes() {
        if (checkSave == false) {
            Object mes[] = {"Chơi lại?", "Thoát"};
            int option = JOptionPane.showOptionDialog(null, "Bạn có muốn chơi lại ?",
                    "Lưu ý!",
            ...
            Object mes[] = {"Game mới", "Tiếp tục", "Thoát"};
            int option = JOptionPane.showOptionDialog(null, "Bạn có muốn chơi tiếp không?",
                    "Lưu ý!",
                    JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE,
                    null, mes, mes[0]);
