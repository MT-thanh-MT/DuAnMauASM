...
public class ReadQRCodeOfUser extends javax.swing.JFrame implements Runnable, ThreadFactory {
    ...
    public ReadQRCodeOfUser(DangNhapJDialog dangNhapJDialog) {
        initComponents();
...
//            java.util.logging.Logger.getLogger(ReadQRCodeOfUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
//        }
//        //</editor-fold>
//        //</editor-fold>
//        //</editor-fold>
...
//            new ReadQRCodeOfUser().setVisible(true);
//        });
//    }
            ...
            if (result != null) {
                try {
                    ...
                    if (Auth.nguoiDungHienTai == null) {
                        result_field.setText("Tài khoản Không tồn tại!");
                        return;
                    } else if (Auth.nguoiDungHienTai.isTrangThai() == false) {
                        result_field.setText("Tài khoản của bạn đã bị khóa!");
                        return;
                    }
                    MessegerHelper.alert("Bạn đang đăng nhập với tài khoản: "+result.getText(), this);
                    this.dispose();
                    this.dangNhapJDialog.dispose();
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
